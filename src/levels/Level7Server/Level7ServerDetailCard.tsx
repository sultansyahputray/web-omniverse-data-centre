...
export const Level7ServerDetailCard: React.FC<Level7ServerDetailCardProps> = ({
    ...
    // Dynamic metrics based on server number, matching stage structure:
    // 2 Super Chips -> 2 Vera CPUs, 4 Rubin GPUs per Compute Tray
    const metrics = useMemo(() => {
        ...
        return {
            ...
            rubinGpu2: String(Math.round(46 + delta)),
            rubinGpu3: String(Math.round(50 + delta * 2)),
            rubinGpu4: String(Math.round(47 + delta)),
    ...
    return (
        <div className="level7-server-detail-card">
            ...
            {/* Tab Contents: Single column list */}
            <div className="server-card-content">
                {activeTabIdx === 1 && (
                    // COOLING TAB: 2 Vera CPUs, 4 Rubin GPUs
                    <div className="server-card-list">
                        ...
                        {renderParamRow('Rubin GPU 3 Temperature', metrics.rubinGpu3, '°C')}
                        {renderParamRow('Rubin GPU 4 Temperature', metrics.rubinGpu4, '°C')}
                    </div>
                )}
